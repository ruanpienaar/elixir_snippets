defmodule PentoWeb.ProductLiveTest do
  ...
  @create_attrs %{name: "some name", description: "some description", unit_price: 120.5, sku: "some sku"}
  @update_attrs %{name: "some updated name", description: "some updated description", unit_price: 456.7, sku: "some updated sku"}
